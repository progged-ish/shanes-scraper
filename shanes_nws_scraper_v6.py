...
def process_office(args):
    ...
    # Get AI summary for this office (with office_id for timing)
    ai_summary = get_ai_summary(discussion, office_id)
...
"""
    ...
    if '_conus_summary' in processed_data:
        ...
        converted_summary = conus_summary.replace("#", "").replace("##", "").replace("###", "<strong>").replace("\n\n", "</strong><br><br>")
